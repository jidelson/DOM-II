...
const pwColor = document.querySelector('input[type="text"]');
...
// nest and stoppropagate
const boxForStopProp = document.getElementById('boxForStopProp');
const myBtn = document.getElementById('myBtn');

boxForStopProp.addEventListener('click', function(){
  this.style.backgroundColor = 'orange';
});

myBtn.addEventListener('click', function(e){
  e.stopPropagation();
  console.log("The button was pressed and the box did not turn orange!")
})

// stop nav links from refreshing page

const stopNavRefresh = document.getElementsByClassName('nav-link');
stopNavRefresh.addEventListener('click', function(e){
e.preventDefault();
})